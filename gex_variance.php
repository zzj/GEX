...
function gex_variance_local_opt_analysis($config){
     gex_r_analysis($config, gex_get_variance_folder($config), 'variance.local.opt.analysis.R');
}

function gex_variance_global_opt_analysis($config){
     gex_r_analysis($config, gex_get_variance_folder($config), 'variance.global.opt.analysis.R');
